...
export const Widgets = () => (
  <Container>
    <HeaderMain title="Widgets" className="mb-5 mt-4" />
    {/* START Header 1 */}
    <Row>
      <Col lg={12}>
        <HeaderDemo
          ...
          subTitle={
            <React.Fragment>
              Last Update: <strong>12-23-2018, 4:32:12 PM</strong>, Amount:{" "}
              <strong>4</strong>
            </React.Fragment>
          }
        />
        ...
        <Card className="mb-3">
          ...
          <ListGroup flush>
            <ListGroupItem
              ...
              className="by-0"
            >
              <Attachment BgIconClassName="text-primary" icon="file-word-o" />
            </ListGroupItem>
            <ListGroupItem
              tag={Link}
              to="apps/email-details"
              ...
              className="by-0"
            >
              <Attachment BgIconClassName="text-success" icon="file-excel-o" />
            </ListGroupItem>
            <ListGroupItem
              tag={Link}
              to="apps/email-details"
              ...
              className="by-0 mb-3"
            >
              <Attachment BgIconClassName="text-warning" icon="file-powerpoint-o" />
            </ListGroupItem>
          </ListGroup>
        </Card>
        {/* START Card Widget */}
        ...
        <Card className="mb-3">
          ...
          <ListGroup flush className="mb-4">
            <ListGroupItem
              ...
              className="bt-0"
            >
              <Activity iconColorBelow="success" icon="check" />
            </ListGroupItem>
            <ListGroupItem
              action
              tag={Link}
              ...
              className="bt-0"
            >
              <Activity iconColorBelow="danger" icon="close" />
            </ListGroupItem>
            <ListGroupItem
              action
              tag={Link}
              ...
              className="bt-0"
            >
              <Activity iconColorBelow="warning" icon="exclamation" />
            </ListGroupItem>
            <ListGroupItem
              action
              tag={Link}
              ...
              className="bt-0"
            >
              <Activity iconColorBelow="primary" icon="info" />
            </ListGroupItem>
          </ListGroup>
        </Card>
        {/* END Card Widget */}
      ...
      <Col lg={6}>
        ...
        <Card className="mb-3">
          ...
          <CardFooter className="small">
            ...
            How do your users (visitors), sessions (visits) and pageviews metrics for{" "}
            <abbr title="attribute">www.webkom.com</abbr> compare to your targets

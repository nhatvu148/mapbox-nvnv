    ...
    <React.Fragment>
      {_.times(5, (index) => (
        <tr key={index}>
          ...
          <td className="align-middle text-right">{randomArray(score)}</td>
          <td className="align-middle text-right">{randomArray(q)}</td>
          <td className="align-middle text-right">{randomArray(v)}</td>
          <td className="align-middle text-right">{randomArray(g)}</td>
        </tr>
      ))}
    </React.Fragment>
  );
